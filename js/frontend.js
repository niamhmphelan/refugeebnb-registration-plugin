jQuery(document).ready(function($){
	...
	var $help_other_ways_container = $('.help-other-ways-container'),
			$offer_bed_information = $('.offer-bed-information');


	$('.choice-offer-bed').on('click', function(){
		$help_other_ways_container.hide();
		$offer_bed_information.show();
	});

	$('.choice-help-other-ways').on('click', function(){
		$offer_bed_information.hide();
		$help_other_ways_container.show();
	});
});