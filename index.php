...
class RefugeeBnb{
	...
	public $translationFragments = [
		'Sign up to offer your support with the refugee crisis.',
		'I would like to help in other ways',
		'Connect with us',
		'Email',
		'I can offer a bed for a year',
		'Submit',
		'Invalid Email',
		'You have already signed up. We will be in touch shortly.',
		'Kindly tell us how will you like to help',
		'Thank you for your support! We will be in touch shortly!',
		//10
		'Password',
		'I want to help',
	...
	private function shelterDetail($json)
	{
		...
		//
		// Validation is now invalid as we offer a preset select menu
		//
